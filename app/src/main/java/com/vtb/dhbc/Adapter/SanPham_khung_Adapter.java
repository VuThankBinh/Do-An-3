...
public class SanPham_khung_Adapter extends  RecyclerView.Adapter<SanPham_khung_Adapter.ViewHolder>{
    ...
    ItemClick_cauhoi mClick;

    public SanPham_khung_Adapter(Context context, ArrayList<SanPham> list, ItemClick_cauhoi mClick) {
    ...
    @NonNull
    @Override
    public SanPham_khung_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v= LayoutInflater.from(context).inflate(R.layout.dongsanpham,parent,false);

        return new SanPham_khung_Adapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull SanPham_khung_Adapter.ViewHolder holder, int position) {
        ...
        holder.btnmua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mClick.onItemCauHoiClick(position);
            }
        });
